// TrustHunt Enterprise Content Script

// Avoid double injection
if (window.trustHuntContentScriptInjected) {
  console.log('TrustHunt content script already injected, skipping');
} else {
  window.trustHuntContentScriptInjected = true;
